...
while (True):
    ...
    for (x, y, w, h) in faces:
        ...
        cv2.imwrite(r"C:\Users\Prasanna Reddy\Downloads\easy-real-time-face-recognition-python-master\easy-real-time-face-recognition-python-master\dataset\User" + str(face_id) + '.' +
